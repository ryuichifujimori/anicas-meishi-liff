...
（この記録は前回までのぶんも含む。今回変えたのは**写真を四角で合わせるのをやめ、
リボンの輪郭そのもので切るようにしたこと**だけで、それは 6 章の頭に足してある。
写真の枠の左右はデザイン本来の 2.750〜52.250mm に戻した。）

その前に変えたのは、**写真の窓の左右を、リボンが実際に覆っている範囲まで狭めたこと**。
