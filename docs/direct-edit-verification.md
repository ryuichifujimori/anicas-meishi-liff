...
（この記録は前回までのぶんも含む。今回変えたのは**写真の窓の左右を、リボンが実際に
覆っている範囲まで狭めたこと**だけで、それは 6 章の頭に足してある。）
...
|---|---|---|---|
| 改修前（1匹・2匹・3匹とも） | 2.457 mm | 44.805 mm | 2.750〜52.250 mm |
| **改修後（1匹・2匹・3匹とも）** | 2.457 mm | 44.805 mm | **3.300〜51.700 mm** |
...
| | 左下 | 右下 |
|---|---|---|
| 改修前 | 16〜186 画素（0.06〜0.28 mm 幅） | 133〜143 画素（0.19〜0.21 mm 幅） |
| **改修後（1匹・2匹・3匹とも）** | **0 画素** | **0 画素** |
